var esTranslation = {
  ...
  FORM_INVALID_FORMAT_ERROR: 'Formato inv\álido',
  FORM_EMAIL_ERROR: 'Formato de correo inv\álido',
  ...
  USER_FRIENDSHIP_FOLLOWERS: 'Seguidores',
  ...
  CREATE_PRODUCT_SAVE_DRAFT_MESSAGE_TITLE:  'Guardar en borrador',
  CREATE_PRODUCT_SAVE_DRAFT_MESSAGE_CONTENT: '¿Quiere guardar los datos de este producto en borrador?, de esta manera podra culminar su publicacion luego',
  ...
  CARD_NUMBER: 'Nº de tarjeta',
  CARD_SECURITY_CODE: 'Nº de seguridad (CSV)',
  ...
  CARD_DOCUMENT_NUMBER: 'Nº de documento de identificaci\ón',
  BUY_NOW: 'Comprar',
  SOLD_PRODUCT: 'Vendido',
  SCAN_CARD: 'Escanea tu tarjeta de cr\édito',
  ...
  EDIT_PROFILE_DOCUMENT_ID: 'N\º de identificaci\ón',
